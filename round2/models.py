...
class Constants(BaseConstants):
    ...
    instructions_template = 'round2/Instructions.html'
    pointsend_template = 'round2/PointSend.html'
    pointback_template = 'round2/PointBack.html'
    result_template = 'round2/PointResult.html'
    wait_template = 'round2/PointWait.html'
    select_template = 'round2/SelectTemplate.html'
