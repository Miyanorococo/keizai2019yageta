...
class MyWaitPage(WaitPage):
    template_name = 'round3_2/MyWaitPage.html'
    title_text = "相手が選択中です"
    body_text = "相手の選択を待っています"
...
class SendBackMachine(Page):
    ...
    def vars_for_template(self):
        ...
        return {
                ...
                'cpu_count': cpu_count,
            'prompt': '0ポイントから{}の間で相手に渡すポイントを打ち込んでください'.format(tripled_amount)}
...
class Results1(Page):
    ...
    def vars_for_template(self):
        self.player.ResultNum = 1
        return {
            'tripled_amount': self.group.Sab * Constants.multiplier,
            'tripled_amount2': self.group.Smb * Constants.multiplier
        }
...
class Results2(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            'tripled_amount': self.group.Sab * Constants.multiplier,
            'tripled_amount2': self.group.Smb * Constants.multiplier,
            'tripled_amount3': self.group.Sam * Constants.multiplier
        }
