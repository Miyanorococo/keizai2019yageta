...
class Constants(BaseConstants):
    name_in_url = 'round3_2'
    players_per_group = 2
    num_rounds = 1

    instructions_template = 'round3_2/Instructions.html'
    pointsend_template = 'round3_2/PointSend.html'
    pointback_template = 'round3_2/PointBack.html'
    result_template = 'round3_2/PointResult.html'
    wait_template = 'round3_2/PointWait.html'
    select_template = 'round3_2/SelectTemplate.html'
...
class Subsession(BaseSubsession):
    def creating_session(self):
        new_structure = [[26, 24], [10, 8], [11, 9], [13, 17], [22, 14], [27, 20], [15, 28], [19, 1], [23, 2], [3, 12], [25, 5], [7, 16], [6, 21], [18, 4]]
...
class Group(BaseGroup):
    ...
    # 人か機械の選択 1.人 2.機械
    player_select1 = models.IntegerField(min=1, max=2)
    player_select2 = models.IntegerField(min=1, max=2)
