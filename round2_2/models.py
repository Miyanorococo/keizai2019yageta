...
class Constants(BaseConstants):
    name_in_url = 'round2_2'
    players_per_group = 2
    num_rounds = 1

    instructions_template = 'round2_2/Instructions.html'
    pointsend_template = 'round2_2/PointSend.html'
    pointback_template = 'round2_2/PointBack.html'
    result_template = 'round2_2/PointResult.html'
    wait_template = 'round2_2/PointWait.html'
    select_template = 'round2_2/SelectTemplate.html'
