...
class Constants(BaseConstants):
    ...
    instructions_template = 'round1/Instructions.html'
    pointsend_template = 'round1/PointSend.html'
    pointback_template = 'round1/PointBack.html'
    result_template = 'round1/PointResult.html'
    wait_template = 'round1/PointWait.html'
    select_template = 'round1/SelectTemplate.html'
